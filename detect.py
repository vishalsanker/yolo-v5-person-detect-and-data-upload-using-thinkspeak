        ...
        for i, det in enumerate(pred):  # per image
            ...
            if len(det):
                ...
                for *xyxy, conf, cls in reversed(det):
                    ...
                    im0 = cv2.putText(im0, "{:d} person detected".format(int(n)), org, font, font_scale, color, thickness, cv2.LINE_AA)
                    print(int(n))
                    import requests
                    import pandas as pd
                    ...
                    # Example usage
                    temp = n  # Temperature data to update
